...
This branch (`Personal Work`) contains my personal modifications and improvements to the project.  
To see exactly what has been changed, please check the commit history in this branch.  